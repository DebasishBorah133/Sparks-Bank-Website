...
<body>
  ...
  <table>
    ...
    $username = "root";
    $password = "";
    $conn = mysqli_connect($server, $username, $password, "sparks");
    if (!$conn) {
    ...
    <div class="card container">
      ...
      <form action="transfer.php" method="POST">
        ...
        <select name="reciever" id="dropdown" class="textbox" required>
          ...
          <?php
          $db = mysqli_connect("localhost", "root", "", "sparks");
    ...
    <nav id="sideNav">
      <ul>
        <li><a href="C:/xampp/htdocs/PHP/Sparks%20Foundation%20Project/index.html">HOME</a></li>
    ...
    <div id="hojaplz">
      <img src="image/menu1.png" id="menuBtn">
    </div>
